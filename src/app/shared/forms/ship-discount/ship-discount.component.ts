...
@Component({
  selector: 'app-ship-discount',
  templateUrl: './ship-discount.component.html',
  styleUrls: ['./ship-discount.component.scss'],
})
export class ShipDiscountComponent implements OnInit {
